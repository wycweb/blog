...
class Page{
    ...
    private function url($page){
        return str_replace(urlencode('[PAGE]'), $page, $this->url.'.html');
    }
...
<style>
    ...
    .current{background: #333; color: #FFF; border: #999 1px solid;margin: 0 2px; height: 26px; line-height: 26px; border-radius: 50%; width: 26px; text-align: center; display: inline-block}
</style>
</html>
